...
for xDis=-0.3:0.05:0.3
    ...
    audioData = 0.5*audioData1+audioData2;
    figure(2)
    plot(audioData)
    ...
    %randomize
%     rng(0,'twister')
%     locsRand = 200.*rand(1,length(locsRaw))-100;
%     locsRaw = locsRaw +locsRand;
